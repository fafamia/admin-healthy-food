    ...
    data() {
        return {
            dropdowns: [
                ...
                { label: '促銷活動', iconClass: "fa-solid fa-gift", items: [{ id: 1, label: '推薦商品', route: '/productfeature' }, { id: 2, label: '推薦留言', route: '' }, { id: 3, label: '推薦專欄', route: '' }] },
                { label: '商品管理', iconClass: "fa-solid fa-box-open", items: [{ id: 1, label: '商品總覽', route: '/products' }, { id: 2, label: '商品分類', route: '/productsclass' }, { id: 3, label: '商品TAG', route: '/producttag' }, { id: 4, label: '商品群組', route: '/prodgroup' }, { id: 5, label: '群組明細', route: '/groupdetail' }] },
